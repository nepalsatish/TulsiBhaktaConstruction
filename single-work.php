...
@Date:   20-Jan-2020 10-15-47 AM
@Email:  nepalsatish1@outlook.com
@Last modified by:   satish
@Last modified time: 20-Jan-2020 10-23-22 AM
...
-->
            ...
            <div class="project-card-mobile">
                <div class="section">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 text-left">
                                    <h1 class="font-libre fs48 lh-sm"><strong>Brole Mobile App</strong></h1>
                                ...
                                <div class="col-sm-6 text-left">
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-6">
                                            <div class="project-info-item">
                                                <div class="project-info-title">team</div>
                                                <div class="project-info-descr">LoganCee - Designer<br /> Dustin Mahone - iOS Developer</div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="project-info-item">
                                                <div class="project-info-title">services</div>
                                                <div class="project-info-descr">Branding, UI/UX Design,<br /> Mobile Design</div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="project-info-item">
                    ...
                    <div class="section-item">
                        <div class="project-card-promo full-height" style="background-image: url(img/pic82.jpg);"></div>
                    </div>
                    <div class="section-item text-left">
                        <div class="container">
                            <div class="lead lead-lg">Brole is a startup that aims to supply energy (starting with gas) to domestic household across the UK. Create a very simple yet stunning logotype and promo site that sets the brand of Entice
                                Energy apart from the competitors like a fresh take on an already saturated area.</div>
                        </div>
                    </div>
                    <div class="section-item">
                        <div class="container">
                    ...
                    <div class="section-item text-left">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="lh-lg text-grey">The goal for the website was to bring the look and feel of the brand to the web while creating an easy to navigate, informative site. We took a complex topic and distilled it down to an
                                        organizational structure that would make sense to normal people. To make the content easier to digest, we simplified copy and focused on type pairings and typography rules that make reading on the web much
                                        easier. The overall aesthetic was meant to convey a sense of tradition while inspiring trust.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-lg-11">
                                    <div class="testimonial-item">
                                        <div class="testimonial-text font-libre">“tbc team delivered on every promise. Re-branding was a project we had put off for a while because we knew it would such an undertaking. tbc team made the process
                                            seamless and the quality of the work delivered could not have been better. We are so pleased with the outcome and look forward to a continued working relationship with the tbc team.”</div>
